const LOREM = [
  ...
  'Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod.',
...
export function generateLorem(count = 1) {
  const paragraphs = []
  for (let i = 0; i < count; i++) {
    paragraphs.push(LOREM[i % LOREM.length])
  }
  return { success: true, result: paragraphs.join('\n\n') }
}
